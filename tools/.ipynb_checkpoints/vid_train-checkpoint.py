...
def main(exp, args):
    ...
    # global
    # dataset_val = vid.VIDDataset(file_path='./val_seq.npy',
    #                              img_size=(args.tsize, args.tsize), preproc=Vid_Val_Transform(), lframe=lframe,
    #                              gframe=32, val=True,mode='random',dataset_pth=exp.data_dir)
    # uniform
    # dataset_val = vid.VIDDataset(file_path='./val_seq.npy',
    #                              img_size=(args.tsize, args.tsize), preproc=Vid_Val_Transform(), lframe=0,
    #                              gframe=32, val=True,mode='uniform',dataset_pth=exp.data_dir)
    # local+global
    # dataset_val = vid.VIDDataset(file_path='./val_seq.npy',
    #                              img_size=(args.tsize, args.tsize), preproc=Vid_Val_Transform(), lframe=16,
    #                              gframe=16, val=True,mode='gl',dataset_pth=exp.data_dir)
    # gaussian
    # dataset_val = vid.VIDDataset(file_path='./val_seq.npy',
    #                              img_size=(args.tsize, args.tsize), preproc=Vid_Val_Transform(), lframe=32,
    #                              gframe=0, val=True,mode='ga',dataset_pth=exp.data_dir)
    #local
    dataset_val = vid.VIDDataset(file_path='./val_seq.npy',
                             img_size=(args.tsize, args.tsize), preproc=Vid_Val_Transform(), lframe=32,
                             gframe=0, val=True,mode='lc',dataset_pth=exp.data_dir)
