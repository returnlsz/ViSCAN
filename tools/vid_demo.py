...
class Predictor(object):
    ...
    def inference(self, img,img_path=None):
        ...
        # print("img:len:value:"+str(len(img)))
        if self.device == "gpu":
            img = img.cuda()
        ...
        with torch.no_grad():
            ...
            # print("outputs:shape:value:"+str(outputs[0][0]))
            # print("outputs_ori:shape:value:"+str(outputs_ori[0][0]))
...
def imageflow_demo(predictor, vis_folder, current_time, args):
    ...
    # print("frames:len:value:"+str(len(res[0])))
    ...
    for index,ele in enumerate(res):
        ...
        # print("outputs:shape:value:"+str(outputs[index].shape))
