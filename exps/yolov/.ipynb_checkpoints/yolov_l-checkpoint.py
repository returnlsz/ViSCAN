...
class Exp(MyExp):
    ...
    def get_model(self):
        ...
        # from yolox.models.yolov_msa_reg import YOLOXHead
        from yolox.models.yolov_msa_reg2 import YOLOXHead
        ...
        head = YOLOXHead(self.num_classes, self.width, in_channels=in_channels, heads=16, drop=self.drop_rate)
    ...
    def get_data_loader(
        ...
        # global
        # dataset = vid.VIDDataset(file_path='train_seq.npy',
